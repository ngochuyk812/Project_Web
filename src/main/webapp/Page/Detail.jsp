            ...
            <div class="comment"    >
                ...
                <div class="box-input" >
                    <form action="">
                        ...
                        <div  class="box-bt"><button style="cursor: pointer" id="${id}"class="bt-comment">Gửi đánh giá</button></div>
                    </form>
                </div>
                ...
                <div class="list-comment">
                    <c:forEach items="${listComment}" var="item">
                        <div class="cmt">
                            <div class="start-cmt">
                                <c:forEach begin="1" end="${item.start}">
                                    <i class="fa-solid fa-star"></i>
                                </c:forEach>
                            </div>
                            <p>từ <b>${item.username}</b>, <span class="cl-lg">${item.time}</span></p>
                            <p>${item.comment}</p>
                        </div>
                    </c:forEach>
...
<script type="application/javascript">
    ...
    document.querySelector( ".bt-comment").addEventListener("click",(e)=>{
        ...
        if(idPost&&start&&content&&newdate){
            console.log(content)
            console.log(newdate)
            console.log(idPost)
            console.log(start)
