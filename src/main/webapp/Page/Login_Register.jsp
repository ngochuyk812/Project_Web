            ...
            <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                <form class="form-login">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 d-flex justify-content-center">
                            <!-- Simple link -->
                            <a id="e-forgot" class="link-forgot" href="#!">Forgot password?</a>
                        </div>
                    </div>
...
<%--                 forgot--%>
                <form style="display: none" class="form-forgot">
                    <div class="text-center mb-3">
                        <p>Forgot Password</p>
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <label id="forgot-user" class="form-label" for="loginName">Username</label>
                    </div>
                    <!-- 2 column grid layout -->
                    <!-- Submit button -->
